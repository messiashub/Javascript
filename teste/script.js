...
let totalCategorya = booksByCategory.length;
console.log(totalCategorya)

for(let category of booksByCategory){
    console.log(`Total de livro na categoria é ${category.category}`);
    /*número de livros em cada categoria  */   
    console.log(`Total de books é ${category.books.length}`);
}
